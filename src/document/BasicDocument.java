...
public class BasicDocument extends Document 
{
	...
	{
		// words with the first character being either uppercase or lowercase, 
		// and only contain letters (no numbers or special characters), with at least one character in the word 
		String regex = "[A-Za-z]+";
	    return this.getTokens(regex).size();
	}
